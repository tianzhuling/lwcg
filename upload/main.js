...
delBtn.style.fontSize = '14px';        // 缩小一点字体，❌就往左上偏了
delBtn.style.lineHeight = '20px';      // 行高小一点，❌向上
delBtn.style.paddingLeft = '1px';      // 左边内边距，❌向左
delBtn.style.paddingTop = '1px';       // 上边内边距，❌向上
